...
const MAT: Dictionary = {
	...
	"park":      {"t": 12.5, "sky": 4.0, "e": 0.97, "solar": 1.0, "d": 2, "dt": 2.6, "de": 0.02},
	"road":      {"t": 21.0, "sky": 2.5, "e": 0.93, "solar": 4.0, "d": 3, "dt": 2.0, "de": 0.05},
	"wall":      {"t": 16.5, "sky": 8.5, "e": 0.92, "solar": 5.5, "d": 1, "dt": 2.0, "de": 0.04},
	"window":    {"t": 12.0, "sky": 2.0, "e": 0.75, "solar": 1.5, "d": 5, "dt": 0.8, "de": 0.0},
	"parapet":   {"t": 11.0, "sky": 5.0, "e": 0.91, "solar": 3.0, "d": 2, "dt": 1.0, "de": 0.02},
	"hvac":      {"t": 34.0, "sky": 0.5, "e": 0.93, "solar": 0.0, "d": 4, "dt": 1.5, "de": 0.02},
	"tank":      {"t": 13.0, "sky": 4.0, "e": 0.92, "solar": 2.5, "d": 4, "dt": 0.8, "de": 0.02},
...
static func get_material(name: String, snap_res: Vector2i, snap: int = -1) -> ShaderMaterial:
	...
	var key: String = "%s|%d|%d|%d|%d" % [name, snap_res.x, snap_res.y, int(snap_on), int(detail_on)]
	if _cache.has(key):
		return _cache[key]
	if _shader == null:
